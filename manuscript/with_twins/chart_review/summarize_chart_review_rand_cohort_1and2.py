...
def load_chart_reviews(review_file_1, review_file_2):
...
chart_df = load_chart_reviews(review_file_1, review_file_2)
...
clasif_report_df.to_csv(os.path.join(OUTPUT_DIR, 'classif_report_chart_review1_2_vs_algo_labels.tsv'),sep="\t", index=True, header=True)
conf_matrix_df.to_csv(os.path.join(OUTPUT_DIR, 'conf_matrix_chart_review1_2_vs_algo_labels.tsv'),sep="\t", index=True, header=True)
