...
# load  data
input_file = "/dors/capra_lab/users/abraha1/projects/PTB_phenotyping/results/ptb_predict_machine_learning/2020_06_03_since_conception_icd9_cpt_no_twins_compare_risk_fx/concep_icdcpt_notwins_riskcomp/input_data_up_to_28_weeks_since_preg_start_icd9_cpt_no_twins_count_compare_riskfx-2020-06-03.tsv"
model_file = "/dors/capra_lab/users/abraha1/projects/PTB_phenotyping/results/ptb_predict_machine_learning/2020_06_03_since_conception_icd9_cpt_no_twins_compare_risk_fx/concep_icdcpt_notwins_riskcomp/best_xgb_model_up_to_28_weeks_since_preg_start_icd9_cpt_no_twins_count_compare_riskfx-2020-06-03.pickle"


clinrisk_input_file = "/dors/capra_lab/users/abraha1/projects/PTB_phenotyping/results/ptb_predict_machine_learning/2020_06_03_since_conception_icd9_cpt_no_twins_compare_risk_fx/concep_icdcpt_notwins_riskcomp_redo/input_data_up_to_28_weeks_since_preg_start_icd9_cpt_no_twins_count_compare_riskfx-2020-06-04.tsv"
clinrisk_model_file = "/dors/capra_lab/users/abraha1/projects/PTB_phenotyping/results/ptb_predict_machine_learning/2020_06_03_since_conception_icd9_cpt_no_twins_compare_risk_fx/concep_icdcpt_notwins_riskcomp_redo/best_xgb_model_up_to_28_weeks_since_preg_start_icd9_cpt_no_twins_count_compare_riskfx-2020-06-04.pickle"
...
billing_tn + billing_fp + billing_fn + billing_tp
...
ax.annotate("{}".format(np.round(billing_test_rc,2)), xy=(0, billing_test_rc+0.03), xycoords='data', ha='center', va='center', fontproperties=sprop)
ax.annotate("{}".format(np.round(clin_test_rc,2)), xy=(1, clin_test_rc+0.03), xycoords='data', ha='center', va='center', fontproperties=sprop)
...
plt.savefig(os.path.join(output_dir, f'{DATE}_sptb_post_hoc_recall.pdf'),  bbox_inches = 'tight', pad_inches=0,  transparent=True)
